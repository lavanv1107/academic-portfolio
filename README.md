...
[Click here to finish setting up your workspace!](https://cloud.nx.app/connect/sZLNdAs3YQ)
...
```sh
npx nx serve academic-portfolio
```

To create a production bundle:

```sh
npx nx build academic-portfolio
```

To see all available targets to run for a project, run:

```sh
npx nx show project academic-portfolio
```
